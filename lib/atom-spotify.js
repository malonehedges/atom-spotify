...
export default {
  ...
  initializeSubscriptions() {
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'atom-spotify:toggleShuffle': () => SpotifyApplicationClient.toggleShuffle(),
      'atom-spotify:toggleRepeat': () => SpotifyApplicationClient.toggleRepeat(),
      'atom-spotify:togglePlayPause': () => SpotifyApplicationClient.togglePlayPause(),
      'atom-spotify:goToNextTrack': () => SpotifyApplicationClient.playNextTrack(),
      'atom-spotify:goToPreviousTrack': () => SpotifyApplicationClient.playPreviousTrack(),
      'atom-spotify:openSpotify': () => SpotifyApplicationClient.activateApplication(),
    }))
  },
